...
IndexedTriangleSet::DataItem::DataItem(
    void)
...
void IndexedTriangleSet::addNewVertexChunk(
    void)
    {
    if(pipe!=0)
        {
...
void IndexedTriangleSet::addNewIndexChunk(
    void)
    {
    if(pipe!=0)
        {
...
void IndexedTriangleSet::initContext(
...
void IndexedTriangleSet::receive(
    void)
    {
    while(true)
        {
...
void IndexedTriangleSet::flush(void)
    {
    if(pipe!=0)
        {
